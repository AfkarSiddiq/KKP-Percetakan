                        ...
                        <tr>
                            ...
                            <td>
                                <form id='deleteForm' method="POST" action="{{ route('transaksi.destroy', $trs->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <a target="_blank" class="btn btn-primary btn-sm" href="{{ url('/struk', $trs->id) }}" title="Print Struk">
                                    ...
                                    <!-- hapus data -->
                                    <button onclick="deleteData(this)" type="button" class="btn btn-danger show_confirm btn-sm">
