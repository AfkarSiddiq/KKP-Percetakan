        ...
        <form method="POST" action="{{ route('barang.update', $row->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-floating mb-3">
                <input class="form-control" name="harga_member" value="{{ $row->harga_member }}" id="harga_member"
                    type="text" placeholder="Harga_member" />
                <label for="harga_member">Harga Member</label>
            </div>
            <div class="form-floating mb-3">
                <input class="form-control" name="harga_studio" value="{{ $row->harga_studio }}" id="harga_studio"
                    type="text" placeholder="Harga Studio" data-sb-validations="required" />
                <label for="harga_studio">Harga Studio</label>
                <div class="invalid-feedback" data-sb-feedback="stok:required">Harga Studio is required.</div>
            </div>
            <div class="form-floating mb-3">
